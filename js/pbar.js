...
(function(root, factory) {
    ...
    var defaults = {
        ...
        plugin = {
            ...
            showGradient: function($fill, opts) {
                if (opts.gradient) {
                    var angle = opts.gradientType ? "90deg" : "180deg",
                        startColor = opts.gradientType ? opts.gradientEndColor : opts.gradientStartColor,
                        endColor = opts.gradientType ? opts.gradientStartColor : opts.gradientEndColor;
                    $fill.css({
    ...
    pbar.prototype = {
        ...
        setValue: function(value) {
            ...
            var $fill = $(this.dom).find(".fill"),
                barWidth = plugin.parsePercent(opts.value);
